...
e <- scuttle::sumCountsAcrossCells(assays(se2)$scaledLFC[degs2h,], se2$condition2, average=TRUE)
colnames(e) <- gsub("> ", ">\n", colnames(e))
h <- hclust(as.dist(1-cor(assay(e))))
pdf("clustering.pdf", width=5, height=4)
plot(h, main="Clustering of conditions", xlab="Based on Pearson correlation of the scaled logFC", sub="of genes responding to 2h DEX")
dev.off()
```
